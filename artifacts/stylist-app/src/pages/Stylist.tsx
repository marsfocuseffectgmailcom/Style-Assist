  ...
  return (
    <AppShell>
      ...
      <div className="mt-5 flex items-center gap-3 rounded-[18px] border border-white/10 bg-[#151922] px-4 py-3">
        ...
        />
        <button className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-[#FF4D8D] to-[#FF7A5C] text-white shadow-[0_8px_24px_rgba(255,92,130,0.28)]">
