  ...
  return (
    <AppShell>
      <header className="mb-6 flex items-start justify-between pt-4">
        <div>
          <p className="text-sm text-[#A8AFBE]">Stress-free dressing</p>
          <h1 className="text-[28px] font-semibold tracking-[-0.3px]">Plan Ahead</h1>
        </div>

        <button
          onClick={() => navigate("/plan-ahead/new")}
          className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-[#FF4D8D] to-[#FF7A5C] text-white shadow-[0_4px_16px_rgba(255,92,130,0.28)] transition active:scale-[0.97]"
      ...
      {events.length === 0 ? (
        <Card className="text-center py-8">
          ...
          <p className="mx-auto mt-2 max-w-[260px] text-sm leading-6 text-[#A8AFBE]">
                    ...
                    >
                      <Card className="flex items-center gap-4 transition active:scale-[0.99]">
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="truncate text-[15px] font-semibold text-[#F6F3EE]">
                            {event.name}
                          </h3>
                        ...
                        <button
                          ...
                          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/5 text-[#6F7788] transition hover:bg-white/10"
